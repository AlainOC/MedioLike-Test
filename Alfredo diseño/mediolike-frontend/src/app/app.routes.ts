...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'certificates',
        loadComponent: () => import('./features/student/certificates-list/certificates-list.component').then(m => m.CertificatesListComponent)
      },
      {
        path: 'certificate/:id',
        loadComponent: () => import('./features/student/certificate/certificate.component').then(m => m.CertificateComponent)
      },
      {
      ...
      {
        path: 'instructor/live/studio/:id',
        loadComponent: () => import('./features/instructor/live-studio/live-studio.component').then(m => m.LiveStudioComponent),
        canActivate: [roleGuard],
        data: { expectedRoles: ['Instructor', 'Admin'] }
      },
      {
        path: 'live/:id',
        loadComponent: () => import('./features/live/live-viewer/live-viewer.component').then(m => m.LiveViewerComponent)
      },
      {
        path: 'live',
        loadComponent: () => import('./features/live/live-viewer/live-viewer.component').then(m => m.LiveViewerComponent)
      ...
      {
        path: 'events',
        loadComponent: () => import('./features/live-events/live-events.component').then(m => m.LiveEventsComponent)
      },
      {
        path: 'admin/users',
